  ...
  return (
    <article className={styles.post}>
      ...
      <div className={`${styles.postContent}`}>
        <Image src="/image1.png" alt="Saturno no espaço" width={600} height={307} />
        <p>
        ...
        <Image src="/image3.png" alt="Anéis de Saturno" width={600} height={328} />
        ...
        <Image src="/image2.png" alt="Luas de Saturno" width={600} height={315} />
      </div>
